...
class Square extends Shape {
    constructor (letters, txtcolor, bgcolor) {
        super(letters, txtcolor, bgcolor);
        this.letters = `<text fill="${this.txtcolor}" font-weight="600" font-size="70" font-family="Century Gothic" x="50%" y="37%" dominant-baseline="middle" text-anchor="middle">${this.letters}</text>`;
